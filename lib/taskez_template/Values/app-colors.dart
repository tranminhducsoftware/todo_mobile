...
class AppColors {
  ...
  static final Color primaryBackgroundColor = HexColor.fromHex("#3699ff");
  static final Color lightMauveBackgroundColor = HexColor.fromHex("#313a55");
  static final Color primaryAccentColor = HexColor.fromHex("#313a55");
}
