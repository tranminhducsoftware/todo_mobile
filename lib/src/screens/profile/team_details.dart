...
import 'package:todo_mobile/taskez_template/widgets/Team/more_team_details_sheet.dart';
import 'package:todo_mobile/taskez_template/widgets/table_calendar.dart';
          ...
          child: SafeArea(
            ...
            ValueListenableBuilder(
                ...
                builder: (BuildContext context, _, __) {
                  return _settingsButtonTrigger.value == 0 ? const Expanded(child: TeamProjectOverview()) : CalendarView();
                })
          ])))
    ]));
  }
